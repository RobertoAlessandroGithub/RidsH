...
<body class="text-white font-sans">
    ...
    <!-- Restaurant Section -->
    <section id="restaurant" class="bg-gray-100 text-gray-900 py-16 px-4 md:px-8">
        <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center md:flex-row-reverse" data-aos="fade-left">
            <img src="images/379088455.jpg" alt="Restaurant"
                class="rounded-lg shadow-lg w-full h-[300px] object-cover object-center">
            <div>
                <h2 class="text-3xl font-bold mb-4">Gastro Restaurant</h2>
                ...
                <a href="#" class="inline-block bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700 transition">Lihat Restoran</a>
            </div>
        </div>
    </section>
